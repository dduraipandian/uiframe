 ...
 */
class Dropdown extends core.EmitterComponent {
  /**
  ...
  #searchListener() {
    ...
    const debouncedHandleSearch = core.Utility.debounce(this.handleSearch.bind(this), 100);
 ...
 * @extends EmitterComponent
 */
class Tree extends core.EmitterComponent {
  /**
   * @param {Object} options
  ...
  loadChild(childContainer, object, parentPathId) {
    ...
    let data = core.Utility.deepValue(this.objects, uri);
    if (this.cb && data === undefined) {
      data = this.cb(object);
      data = core.Utility.deepValue(this.objects, uri, data);
    }
  ...
  update(node, data) {
    ...
    let obj = core.Utility.deepValue(this.objects, uri);
    obj.children = data;
  ...
  refresh(node, data) {
    ...
    core.Utility.deleteValue(this.objects, uri);
    core.Utility.deepValue(this.objects, uri, data);
  ...
  remove(node) {
    ...
    core.Utility.deleteValue(this.objects, node.dataset.uri);
    node.remove();
  }
}
